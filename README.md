...
├── workbuddy/                   # WorkBuddy 全场景 AI 工作台系列 🔥 新开系列
...
| WorkBuddy | `workbuddy/` | 1/20 篇 | 腾讯全场景 AI 工作台：设计、建站、调研零门槛交付 |
...
多模型协同 · AI Agent 工作流 · 私有知识库（RAG） · 本地部署大模型 · 流程风控 · Skills 机制 · MCP 协议 · Automation 自动化 · 向量数据库 · GGUF 量化 · 软件测试 · 职业发展 · 一人公司 · AI 自动化测试 · API/Web/移动端测试 · Playwright · Selenium · Appium · pytest · ComfyUI · DeepSeek V4 · DeepSeek Harness · WorkBuddy
