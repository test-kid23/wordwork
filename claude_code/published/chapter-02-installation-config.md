# Claude Code 装不上？这 5 个坑，第 3 个 90% 的人踩过
...
ccswitch 是一个本地代理工具，把 Claude Code 的请求转发到指定模型 API。GitHub 开源项目，搜 **ccswitch** 就能找到。

安装方式通常是一键脚本或者二进制下载，具体跟着 README 走——不同版本安装方式可能不同，不写死命令。
